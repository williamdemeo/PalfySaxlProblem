...
It is clear that the relations $\alpha_1, \dots, \alpha_5$ are pairwise
permuting pairwise complements (\acs{PPPC}).  Also $\beta$ is pairwise
complementary by not permuting with each $\alpha_i$, for $i\neq 3$.
Here are some other facts which can be helpful aids to intuition.
\begin{fact}
