...
In the paper \cite{PalfySaxl}, Peter P\'{a}lfy and Jan Saxl pose the following 
\begin{quote}
...
implies they have complmentary blocks, so
\begin{equation}
  \label{eq:2}
|x/\alpha_1| = |x/\alpha_2|^{-1} \cdot |X|= \nb{\alpha_2}.
\end{equation}
(This holds for all $x\in X$. Recall that complemntary blocks are always
uniform.) 
